...
define(['jquery',
  ...
  var DragUploaderPlugin = function(element) {
    ...
    me.$checkboxForRights = $('<label for="checkFalUploads"><input type="checkbox" id="checkFalUploads" value="1" />' + TYPO3.lang['dragUploader.iHaveTheRights'] + '</label>');
    me.$checkForFalUploads = $('<div class="checkbox" />').append(me.$checkboxForRights).hide();
  ...
  var initialize = function() {
    ...
    if (
      ...
      && 'undefined' !== typeof TYPO3.settings.RequireJS.PostInitializationModules['TYPO3/CMS/Checkfaluploads/DragUploader']
    ) {
